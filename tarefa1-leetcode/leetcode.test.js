...
describe('Valid Parentheses', () => {
  describe('isValid', () => {
    ...
    test('deve lidar com string longa válida', () => {
      ...
      console.log(`isValid(longString 2000 chars): ${(endTime - startTime).toFixed(2)}ms`);
      expect(result).toBe(true);
    });
    ...
    test('deve lidar com string longa inválida', () => {
      ...
      console.log(`isValid(longString 1999 chars): ${(endTime - startTime).toFixed(2)}ms`);
      expect(result).toBe(false);
    });
  });
  ...
  describe('findFirstError', () => {
    ...
    test('deve lidar com string longa e encontrar erro', () => {
      ...
      console.log(`findFirstError(longString 1999 chars): ${(endTime - startTime).toFixed(2)}ms`);
      expect(result.valid).toBe(false);
      expect(result.error).toContain('não foi fechado');
    });
  });
  ...
  describe('Performance Tests', () => {
    test('deve processar string muito longa rapidamente', () => {
      ...
      console.log(`isValid(veryLongString 6000 chars): ${(endTime - startTime).toFixed(2)}ms`);
      expect(result).toBe(true);
    ...
    test('deve encontrar erro rapidamente em string longa', () => {
      ...
      console.log(`findFirstError(veryLongString 9999 chars): ${(endTime - startTime).toFixed(2)}ms`);
      expect(result.valid).toBe(false);
      expect(endTime - startTime).toBeLessThan(100); // Deve ser rápido
    });
  });
